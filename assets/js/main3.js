...
// Array of rate bands and tax rates for the second house with increased rates
const rateIncrease = [0.10, 0.11, 0.13, 0.14, 0.15]; // Increases for each rate band
const rateBandsSecondHouse = rateBandsFirstHouse.map((band, index) => ({ ...band, rate: band.rate * (1 + rateIncrease[index]) }));
